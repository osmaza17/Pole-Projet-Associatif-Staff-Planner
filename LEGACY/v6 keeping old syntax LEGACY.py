...
def solve_model(data):
    ...
    # IN CASE WE WANT ABSOLUTELY NO GAPS BETWEEN TASKS, WE CAN ADD THIS HARD CONSTRAINT
    #for p in people:
    #    for j in days:
...
def main(page: ft.Page):
    ...
    def do_solve(e):
        ...
        weights = dict(W_COVERAGE=100000, W_MANDATE=50000, W_STABILITY=10000,
                       ...
                       W_SOCIAL=100, W_GAP=600, W_QUOTA=10, W_PREF=5)
