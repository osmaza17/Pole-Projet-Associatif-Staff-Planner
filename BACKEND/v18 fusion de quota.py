...
def main(page: ft.Page):
    ...
    skills_quota_ct = ft.ListView(expand=True, spacing=5)
    ...
    def build_skills_quota():
        ...
        skills_buf.append(ft.Row([
            make_reset_btn("Reset Skills & Quota", _reset_skills_quota),
            ft.Container(
    ...
    def build_force():
        ...
        buf.append(ft.Row([
            dd_day, dd_task,
            make_reset_btn("Reset to Default", _reset_force)
        ], spacing=20))
    ...
    menu_items_def = [
        ...
        ("Skills & Quota",ft.Icons.STAR_BORDER,         3),
        ("Force",         ft.Icons.LOCK_OUTLINE,        4),
        ("Social",        ft.Icons.PEOPLE_OUTLINE,      5),
        ("Weights",       ft.Icons.TUNE,                6),
    ...
    page_contents = {
        0: dim_tab_content,
        1: ft.Container(avail_ct, padding=10, expand=True),
        2: ft.Container(demand_ct, padding=10, expand=True),
        3: ft.Container(skills_quota_ct, padding=10, expand=True),
        4: ft.Container(force_ct, padding=10, expand=True),
        5: ft.Container(social_ct, padding=10, expand=True),
        6: ft.Container(weights_ct, padding=10, expand=True),
        7: ft.Container(output_ct, padding=10, expand=True),
    }

    builders = {
        1: build_avail, 2: build_demand, 3: build_skills_quota,
        4: build_force, 5: build_social, 6: build_weights}
