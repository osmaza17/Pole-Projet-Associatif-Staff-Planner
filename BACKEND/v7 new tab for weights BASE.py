...
def main(page: ft.Page):
    ...
    dim_tab_content = ft.Container(content=ft.Row(controls=[tf_people, tf_tasks, tf_hours, tf_days], spacing=20, alignment=ft.MainAxisAlignment.START, vertical_alignment=ft.CrossAxisAlignment.START), padding=20, expand=True)
