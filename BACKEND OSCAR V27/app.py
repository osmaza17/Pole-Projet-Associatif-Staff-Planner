...
class StaffSchedulerApp:
    ...
    def _apply_loaded_profile(self):
        ...
        # Rules tab rebuilds all three rule managers (captain, mandatory, quota)
    ...
    def _build_ui(self):
        ...
        # NEW ORDER: 0 Dim · 1 Avail · 2 Demand · 3 Skills · 4 Rules ·
        #            5 Social · 6 Config · 7 Output
        self._page_contents = {
